...
The main goal of this project is to calculate the sentiment (positive or negative) expressed by a Tweet.

Thee feelings are calculated and are based on **NLP algorithms and models developed by Expert System**.


-----------------------------
## Table of Contents
1. [Tweet Subset JSON Schema](#1.tweet-subset-schema)
2. [Sentiment API](#sentiment-api)
3. [Sentiment Analysis](#sentiment-analysis)

-----------------------------
## <a id="1.tweet-subset-schema">1 - Tweet Subset JSON Schema</a>
As described in the project [TWITEER Tweet Parser](https://github.com/faucon-consortium/twitter-tweet-parser), a Tweet in JSON have a huge amount of fields and attributes. 

For our case and after analysis we decided to keep a few data, only the most relevant fields   
